...
function Navbar() {
	...
	return (
		<div className=" fixed z-20 md:w-full  min-w-lg">
						...
						<div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
							...
							<div className="ml-3 relative hidden md:block">
								<div className="flex">
									...
									>
										<FaRegUserCircle size={30} className="ml-2" />
										{/* <span className="sr-only">Open user menu</span> */}
										<span className="p-2"> Deepak kumar</span>
									</button>
								</div>
								...
								{show == true && (
									...
									>
										...
										<a
											...
											tabIndex="-1"
											id="user-menu-item-2"
											onClick={() => sessionStorage.removeItem('auth')}
										>
											Sign out
										</a>
									</div>
